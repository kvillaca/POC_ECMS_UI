...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            livereload: {
                options: {
                    ...
                    middleware: function (connect) {
                        return [
                            require('grunt-connect-proxy/lib/utils').proxyRequest,        // commented out for now, :dist doesn't like the proxy
                            connect.static('.tmp'),
                            connect().use(
                                '/bower_components',
                ...
                options: {
                    ...
                    middleware: function (connect) {
                        return [
                            ...
                            /*connect().use(
                                             '/BucketStorage/',      // be as specific as possible here
                                             connect.static('./test/mocks/docview/1.json')
                                           ),*/
                            connect.static(appConfig.app)
                        ];
                    }
            ...
            server: {
                ...
                proxies: [
                    ...
                    },
                    {
                        ...
                        https: false//,
                        //changeOrigin: true,
                        //rewrite: {'/POC_ECMS_AUTH' : '/taxonomy'}
                        //xforward: false
                    }
                ]
                //proxies: [
        ...
        concat: {
            ...
            css: {
                ...
                dest: '<%= yeoman.app %>/styles/all.css'
            }
        },
                ...
                files: [
                    {
                        expand: true,
                        cwd: '<%= yeoman.dist %>',
                        src: ['*.html', 'views/{,*/}*.html', 'templates/{,*/}*.html', 'scripts/{,*/}*.html'],
                        dest: '<%= yeoman.dist %>'
                    }
                ]
            }
        ...
        less: {
            ...
            all: {
                ...
                files: {
                    ...
                    '<%= yeoman.app %>/styles/application.css': '<%= yeoman.app %>/styles/{,*/}*.less'
                }
            }
        },
        ...
        war: {
            target: {
                options: {
                    war_dist_folder: '.', /* Folder where to generate the WAR. */    // jshint ignore:line
                    war_name: 'ecmsui'                    /* The name fo the WAR file (.war will be the extension) */   // jshint ignore:line
                },
                files: [
                    {
                        expand: true,
    ...
    grunt.registerTask('build', [
        ...
        'less',
        'concurrent:dist', //Copy css, fonts to /dist
